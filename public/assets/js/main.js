jQuery(function ($) {
  ...
  if ($(".ftproductgr").length) {
    $(".ftproductgr").slick({
      ...
      arrows: true,
      autoplay: true,
      prevArrow: '<button class="arrow-back"> <img src="asset/images/home-six/arroe-left.png" alt=""></button>',
      nextArrow: '<button class="arrow-next"> <img src="asset/images/home-six/arroe-right.png" alt=""></button>',
      autoplaySpeed: 2000,
      pauseOnHover: false,
      responsive: [{
          breakpoint: 992,
  ...
  if ($(".hero-slider").length) {
    $(".hero-slider").slick({
      ...
      arrows: true,
      autoplay: true,
      prevArrow: '<button class="arrow-back"><img src="asset/images/home-four/arrow-left.png" alt="images"> </button>',
      nextArrow: '<button class="arrow-next"> <img src="asset/images/home-four/arrow-right.png" alt="images"></button>',
      autoplaySpeed: 2000,
      pauseOnHover: false,
      responsive: [{
          breakpoint: 576,
